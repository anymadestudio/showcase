...
/***/ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/lib/index.js!./src/main.css":
/*!********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--4-1!./node_modules/postcss-loader/lib!./src/main.css ***!
  \********************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/lib/index.js!./src/swiper.css":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--4-1!./node_modules/postcss-loader/lib!./src/swiper.css ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const createImageElements = path => {
  const newDiv = document.createElement("div");
  newDiv.classList.add("swiper-slide");

  var isVideo = new RegExp(/.mp4$/);

  if (path.match(isVideo)) {
    const videoEL = document.createElement("video");
    videoEL.classList.add("project-thumb__img");
    videoEL.setAttribute("controls", true);
    videoEL.setAttribute("src", path);

    newDiv.appendChild(videoEL);
    return newDiv;
  } else {
    const imgEL = document.createElement("img");
    imgEL.classList.add("project-thumb__img");
...
const buildProjectDOM = ({ container, name, images, modes, defaultMode }) => {
  ...
  swiperPrev.classList.add(`swiper-next`);
  swiperNext.classList.add(`swiper-prev`);
  controls.classList.add("controls");

  project.setAttribute("data-mode", defaultMode);

  swiperContainer.appendChild(swiperWrapper);
  swiperContainer.appendChild(swiperPagination);
  swiperContainer.appendChild(swiperPrev);
  swiperContainer.appendChild(swiperNext);
  project.appendChild(swiperContainer);
  project.appendChild(controls);
  container.appendChild(project);

  const mediaPaths = images.map(string => `./files/${string}`);
  const imageElements = mediaPaths.map(createImageElements);

  imageElements.forEach(el => swiperWrapper.appendChild(el));

  return { project, controls, swiperContainer };
};

/* harmony default export */ __webpack_exports__["default"] = (buildProjectDOM);
...
/*!****************************************!*\
  !*** ./src/components/swiperParams.js ***!
  \****************************************/
/*! exports provided: swiperStrobo, swiperSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swiperStrobo", function() { return swiperStrobo; });
...
var content = __webpack_require__(/*! !../node_modules/css-loader/dist/cjs.js??ref--4-1!../node_modules/postcss-loader/lib!./main.css */ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/lib/index.js!./src/main.css");
